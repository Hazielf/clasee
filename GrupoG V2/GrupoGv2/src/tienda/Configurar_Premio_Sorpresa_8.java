...
public class Configurar_Premio_Sorpresa_8 extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			Configurar_Premio_Sorpresa_8 dialog = new Configurar_Premio_Sorpresa_8();
	 ...
	 * Create the dialog.
	 */
	public Configurar_Premio_Sorpresa_8() {
		...
		txtnumeroClienteSorpresa.setText(Menu_Principal_1.numeroClienteSorpresa+"");
		txtpremioSorpresa.setText(Menu_Principal_1.premioSorpresa);
	...
	protected void actionPerformedBtnaceptar(ActionEvent e) {
		...
		Menu_Principal_1.numeroClienteSorpresa=Integer.parseInt(txtnumeroClienteSorpresa.getText());
		Menu_Principal_1.premioSorpresa=txtpremioSorpresa.getText();
	}
}
