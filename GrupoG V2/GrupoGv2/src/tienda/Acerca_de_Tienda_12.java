...
public class Acerca_de_Tienda_12 extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			Acerca_de_Tienda_12 dialog = new Acerca_de_Tienda_12();
