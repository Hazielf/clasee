...
public class Configurar_Descuento extends JDialog implements ActionListener {
	...
	public Configurar_Descuento() {
		...
		txtporcentaje1.setText(Menu_Principal_1.porcentaje1+"");
		txtporcentaje2.setText(Menu_Principal_1.porcentaje2+"");
		txtporcentaje3.setText(Menu_Principal_1.porcentaje3+"");
		txtporcentaje4.setText(Menu_Principal_1.porcentaje4+"");
	}
	...
	protected void actionPerformedBtnaceptar(ActionEvent e) {
		...
		Menu_Principal_1.porcentaje1=Double.parseDouble(txtporcentaje1.getText());
		Menu_Principal_1.porcentaje2=Double.parseDouble(txtporcentaje2.getText());
		Menu_Principal_1.porcentaje3=Double.parseDouble(txtporcentaje3.getText());
		Menu_Principal_1.porcentaje4=Double.parseDouble(txtporcentaje4.getText());
