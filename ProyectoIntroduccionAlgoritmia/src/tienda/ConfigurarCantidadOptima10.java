...
public class ConfigurarCantidadOptima10 extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			ConfigurarCantidadOptima10 dialog = new ConfigurarCantidadOptima10();
	 ...
	 * Create the dialog.
	 */
	public ConfigurarCantidadOptima10() {
		...
		txtcantidadTotalOptima.setText(Main1.cantidadTotalOptima+"");
	}
	...
	protected void actionPerformedBtnaceptar(ActionEvent e) {
		...
		Main1.cantidadTotalOptima=Integer.parseInt(txtcantidadTotalOptima.getText());
	}
}
