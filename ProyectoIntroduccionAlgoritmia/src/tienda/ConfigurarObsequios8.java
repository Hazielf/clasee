...
public class ConfigurarObsequios8 extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			ConfigurarObsequios8 dialog = new ConfigurarObsequios8();
	...
	public ConfigurarObsequios8() {
		...
		txtcantidadObsequiable.setText(Main1.cantidadObsequiable+"");
		txtobsequio.setText(Main1.obsequio);
	}
	...
	protected void actionPerformedBtnaceptar(ActionEvent e) {
		...
		Main1.cantidadObsequiable=Integer.parseInt(txtcantidadObsequiable.getText());
		Main1.obsequio=txtobsequio.getText();
	}
}
